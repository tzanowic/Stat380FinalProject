...
HospitalBeds <- read.csv("API_SH.MED.BEDS.ZS_DS2_en_csv_v2_3931798.csv")
```
...
CountryNumbers <-
  inner_join(CountryNumbers, HospitalBeds, by = "Country.Code") 

colnames(CountryNumbers)[1] <- "Name"
colnames(CumulativeCovid)[1] <- "Name"
```
