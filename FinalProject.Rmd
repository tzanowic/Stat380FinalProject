...
```{r}
# All Variables
deathrate.fit <- lm(data = FullStatsNA, deathsper100000 ~ gdpcap + urbpop + HealthExppCap + AirTransport + AgeDependancy + MilitaryEx + HospitalBeds + PovertyRate, na.rm = TRUE)
