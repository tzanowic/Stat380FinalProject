...
CountryNumbers <-
  inner_join(CountryNumbers, HealthExpCap, by = "Country.Name")
CountryNumbers <-
  inner_join(CountryNumbers, AirTravel, by = "Country.Name")
CountryNumbers <-
  inner_join(CountryNumbers, AgeDependancy, by = "Country.Name")
CountryNumbers <-
  inner_join(CountryNumbers, MilitaryExp, by = "Country.Name")
```
